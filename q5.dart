...
void main() {
  ...
  for (int i = 0; i < 15; i++) {
    ...
    while (vetor.contains(valor)) {
      print('Valor já existe, digite outro valor:');
  ...
  // Lê o valor para verificar se está na lista
  ...
  if (vetor.contains(valorBusca)) {
    ...
    if (index.isEven) {
      print("O valor está na lista e é par");
      stdout.write("Posição de número: ");
      print(index);
    } else {
      print("O valor está na lista e é ímpar");
      stdout.write("Posição de número: ");
      print(index);
    }
  } else {
